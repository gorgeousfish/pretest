...
*!
*! Provides fundamental utility functions for the pretest Stata package.
*!
*! Functions:
*!   _pretest_check_dim()         - Validate vector dimensions
*!   _pretest_safe_div()          - Safe division (avoid division by zero)
*!   _pretest_lp_norm()           - Compute Lp norm
*!   _pretest_make_index_map()    - Create time-to-index mapping
*!   _pretest_find_time_index()   - Find index for original time value
*!   _pretest_is_consecutive()    - Check if time values are consecutive
*!   _pretest_validate_positive() - Validate positive scalar
*!   _pretest_conjugate_exponent()- Compute conjugate exponent q
*!
*! Naming convention: All internal functions use _pretest_ prefix
*!
*! Reference:
