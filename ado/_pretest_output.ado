...
*!
*!   Under this assumption, the pass-case interval endpoints centered on delta_bar
*!   (informative about average ATT only under the conditional extrapolation assumption):
...
program define _pretest_output, rclass
    ...
    if missing(`phi') {
        ...
        // Pre-test passed: display pass-case interval endpoints centered on delta_bar
